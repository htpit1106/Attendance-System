...
class UserAdapter : RecyclerView.Adapter<UserAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var imgstatusaccout: TextView = itemView.findViewById(R.id.txtstatusaccout)
...
//            if(user.status == "1") {
//                imgstatusaccout.setImageResource(R.drawable.check_mark)
//            } else{
//                imgstatusaccout.setImageResource(R.drawable.tamkhoa)
//            }
